...
public class contenido_intermedio extends AppCompatActivity implements RecyclerAdapter2.RecyclerItemClick, SearchView.OnQueryTextListener {
    ...
    private List<ItemList> getItems() {
        ...
        itemLists.add(new ItemList("clases", "Declaración de clases en PHP", R.drawable.transparent_b));
        ...
        itemLists.add(new ItemList("destructores", "Uso de destructores en PHP", R.drawable.transparent_b));
